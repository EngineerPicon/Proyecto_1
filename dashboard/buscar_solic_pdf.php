...
<div class="container">
    <h1>Buscar Solicitud en formato PDF</h1>
<!-- Inicio Código de menu lateral -->

		</tr>
		<hr><center><form method="POST" action="soli_unic_pdf.php">
		<!-- id = "codigo1" eso nos lleva al script para que solo nos pueda detectar E y V para la cedula... -->
